...
class DataAccessForm(FlaskForm):
    ...
    Plate_Min = StringField('Plate_Min')
    Plate_Max = StringField('Plate_Max')
    MJD = StringField('MJD')
    MJD_Min = StringField('MJD_Min')
    MJD_Max = StringField('MJD_Max')
    Fiber = StringField('Fiber')
    Fiber_Min = StringField('Fiber_Min')
    Fiber_Max = StringField('Fiber_Max')
