...
VALUES (SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", 1), 
        SUBSTRING_INDEX(SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -2), "-", 1), 
        SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -1), "-", 2))
FROM quasarinfo;
