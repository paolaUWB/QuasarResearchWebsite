...
VALUES (SELECT SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", 1) FROM quasarinfo,
        SELECT SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -2), "-", 1) FROM quasarinfo, 
        SELECT SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -1), "-", 2) FROM quasarinfo);
