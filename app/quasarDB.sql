...
SELECT 
     REPLACE(PLATE_MJD_FIBER, SUBSTRING_INDEX(PLATE_MJD_FIBER, '-', -1), '') as Plate,
     REPLACE(PLATE_MJD_FIBER, SUBSTRING_INDEX(PLATE_MJD_FIBER, '-', -1), '') as MJD,
     REPLACE(PLATE_MJD_FIBER, SUBSTRING_INDEX(PLATE_MJD_FIBER, '-', -1), '') as Fiber,
FROM quasarinfo;
