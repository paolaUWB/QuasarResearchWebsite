...
INSERT INTO quasarinfo (PLATE)
VALUES (SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", 1) FROM quasarinfo);

INSERT INTO quasarinfo (MJD)
VALUES (SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -2) "-", 1) FROM quasarinfo);

INSERT INTO quasarinfo (FIBER)
VALUES (SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -1), "-", 2) FROM quasarinfo);
...
INSERT INTO quasarinfo_table2 (PLATE)
VALUES (SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", 1) FROM quasarinfo);

INSERT INTO quasarinfo_table2 (MJD)
VALUES (SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -2), "-", 1) FROM quasarinfo);

INSERT INTO quasarinfo_table2 (FIBER)
VALUES (SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -1), "-", 2) FROM quasarinfo);