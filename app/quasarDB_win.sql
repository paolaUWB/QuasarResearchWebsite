...
SELECT 
     SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", 1) AS Plate,
     SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -2), "-", 1) AS MJD,
     SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, "-", -1), "-", 2) AS Fiber
FROM quasarinfo;
