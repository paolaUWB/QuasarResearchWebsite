...
UPDATE quasarinfo
    SET PLATE = SUBSTRING_INDEX(PLATE_MJD_FIBER, '-', 1),
        MJD = SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, '-', -2), '-', 1),
        FIBER = SUBSTRING_INDEX(SUBSTRING_INDEX(PLATE_MJD_FIBER, '-', -1), '-', 2);